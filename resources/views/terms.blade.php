...
<body class="terms_privacy-policy">
  ...
  <section id="privacy-policy">
    ...
    <ol>
      ...
      <li>
      </li>外部送信、第三者提供、情報収集モジュールの有無
        <p>本サービスにはGoogleアナリティクスが組み込まれています。これに伴い、Googleアナリティクス提供者への利用者情報の提供を行います。</p>
        <p>上記提供者のプライバシーポリシーは<a href="https://policies.google.com/technologies/partner-sites?hl=ja">こちら</a>の通りです。</p>
      <li>第三者提供
      ...
      <li>個人情報の訂正及び利用停止等
        <p>6-1.	製作者は、ユーザーから、(1)個人情報が真実でないという理由によって個人情報保護法の定めに基づきその内容の訂正を求められた場合、及び(2)あらかじめ公表された利用目的の範囲を超えて取扱われているという理由または偽りその他不正の手段により収集されたものであるという理由により、
        ...
        <p>6-2.　製作者は、ユーザーから、ユーザーの個人情報について消去を求められた場合、製作者が当該請求に応じる必要があると判断した場合は、ユーザーご本人からのご請求であることを確認の上で、個人情報の消去を行い、その旨をユーザーに通知します。</p>
        <p>6-3.　個人情報保護法その他の法令により、製作者が訂正等または利用停止等の義務を負わない場合は、6-1および6-2の規定は適用されません。</p>
      </li>
      <li>お問い合わせ窓口
